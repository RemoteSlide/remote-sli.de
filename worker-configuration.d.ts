/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 716ea44c78fa13b65e367786fb6176f9)
// Runtime types generated with workerd@1.20260908.1 2026-08-22 nodejs_compat
interface __BaseEnv_Env {
	ASSETS: Fetcher;
	REDIRECT_HOSTS: "www.remote-sli.de";
	CANONICAL_ORIGIN: "https://remote-sli.de";
	SESSIONS: DurableObjectNamespace<import("./src/index").SessionRoom>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "SessionRoom";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "REDIRECT_HOSTS" | "CANONICAL_ORIGIN">> {}
}
